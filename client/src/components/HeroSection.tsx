...
const HeroSection: React.FC = () => {
  return (
    <div className=" h-[1000px] md:h-[500px] w-full bg-white shadow-xl rounded-xl p-4 ">
      <div className=" flex-col md:flex-row flex w-full h-full gap-x-10">
        ...
        <div className=" flex-[2]  flex flex-col gap-20 justify-center items-center">
            <h2 className=" font-bold text-4xl border-b-4 border-b-orange-600 text-center">Günlük Planlarınızı Kolayca Yönetin</h2>
